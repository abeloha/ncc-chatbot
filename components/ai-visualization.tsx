...
export function AIVisualization({ mode, isActive }: AIVisualizationProps) {
  ...
  const modeStyles = {
    general: {
      color:
        "border-[#004479]/40  shadow-[#004479]/20  bg-gradient-to-br  from-[#004479]/10  to-[#004479]/5  dark:from-[#004479]/30  dark:to-[#004479]/20",
      particleColor: new THREE.Color(0x004479),
    },
    productivity: {
      color:
